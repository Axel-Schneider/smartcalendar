...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="margin:auto;background:#fff;display:block;" width="50px" height="50px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
        <defs>
            <filter id="ldio-dy0lu9c8uk-filter" x="-100%" y="-100%" width="300%" height="300%" color-interpolation-filters="sRGB">
        ...
        <g filter="url(#ldio-dy0lu9c8uk-filter)">
            ...
            <g>
                <g transform="translate(50 20)">
                    <circle cx="0" cy="0" r="0" fill="#a38bc0" transform="scale(0.5)"></circle>
                </g>
            ...
            <g>
                <g transform="translate(50 20)">
                    <circle cx="0" cy="0" r="1" fill="#a38bc0" transform="scale(0.5)"></circle>
                </g>
            ...
            <g>
                <g transform="translate(50 20)">
                    <circle cx="0" cy="0" r="2" fill="#a38bc0" transform="scale(0.5)"></circle>
                </g>
            ...
            <g>
                <g transform="translate(50 20)">
                    <circle cx="0" cy="0" r="3" fill="#a38bc0" transform="scale(0.5)"></circle>
                </g>
            ...
            <g>
                <g transform="translate(50 20)">
                    <circle cx="0" cy="0" r="4" fill="#a38bc0" transform="scale(0.5)"></circle>
                </g>
            ...
            <g>
                <g transform="translate(50 20)">
                    <circle cx="0" cy="0" r="5" fill="#a38bc0" transform="scale(0.5)"></circle>
                </g>
            ...
            <g>
                <g transform="translate(50 20)">
                    <circle cx="0" cy="0" r="6" fill="#a38bc0" transform="scale(0.5)"></circle>
                </g>
            ...
            <g>
                <g transform="translate(50 20)">
                    <circle cx="0" cy="0" r="7" fill="#a38bc0" transform="scale(0.5)"></circle>
                </g>
            ...
            <g>
                <g transform="translate(50 20)">
                    <circle cx="0" cy="0" r="8" fill="#a38bc0" transform="scale(0.5)"></circle>
                </g>
            ...
            <g>
                <g transform="translate(50 20)">
                    <circle cx="0" cy="0" r="9" fill="#a38bc0" transform="scale(0.5)"></circle>
                </g>
            ...
            <g>
                <g transform="translate(50 20)">
                    <circle cx="0" cy="0" r="10" fill="#a38bc0" transform="scale(0.5)"></circle>
                </g>
            ...
            <g>
                <g transform="translate(50 20)">
                    <circle cx="0" cy="0" r="11" fill="#a38bc0" transform="scale(0.5)"></circle>
                </g>
            ...
            <g>
                <g transform="translate(50 20)">
                    <circle cx="0" cy="0" r="12" fill="#a38bc0" transform="scale(0.5)"></circle>
                </g>
            ...
            <g>
                <g transform="translate(50 20)">
                    <circle cx="0" cy="0" r="13" fill="#a38bc0" transform="scale(0.5)"></circle>
                </g>
            ...
            <g>
                <g transform="translate(50 20)">
                    <circle cx="0" cy="0" r="14" fill="#a38bc0" transform="scale(0.5)"></circle>
                </g>
            ...
            <g>
                <g transform="translate(50 20)">
                    <circle cx="0" cy="0" r="15" fill="#a38bc0" transform="scale(0.5)"></circle>
                </g>
            ...
            <g>
                <g transform="translate(50 20)">
                    <circle cx="0" cy="0" r="16" fill="#a38bc0" transform="scale(0.5)"></circle>
                </g>
            ...
            <g>
                <g transform="translate(50 20)">
                    <circle cx="0" cy="0" r="17" fill="#a38bc0" transform="scale(0.5)"></circle>
                </g>
            ...
            <g>
                <g transform="translate(50 20)">
                    <circle cx="0" cy="0" r="18" fill="#a38bc0" transform="scale(0.5)"></circle>
                </g>
            ...
            <g>
                <g transform="translate(50 20)">
                    <circle cx="0" cy="0" r="19" fill="#a38bc0" transform="scale(0.5)"></circle>
                </g>
